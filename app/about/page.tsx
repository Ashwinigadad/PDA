  ...
  return (
    <div className="bg-[#2D221E] text-[#E8DCC0] min-h-screen flex flex-col items-center p-8">
      <div className="max-w-3xl text-center">
        ...
        <h2 className="text-2xl font-semibold mt-4 mb-3 text-[#F5E6D0]">Our Expertise</h2>
        <p className="text-md leading-relaxed mb-6 text-[#C4A77D]">
        ...
        <h2 className="text-2xl font-semibold mt-4 mb-3 text-[#F5E6D0]">Collaborations & Accreditation</h2>
        <p className="text-md leading-relaxed mb-6 text-[#C4A77D]">
        ...
        <h2 className="text-2xl font-semibold mt-4 mb-3 text-[#F5E6D0]">Why Choose PDA?</h2>
        <ul className="list-disc list-inside text-md leading-relaxed mb-6 text-[#C4A77D]">
